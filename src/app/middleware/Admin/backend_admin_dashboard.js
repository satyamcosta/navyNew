...
export const BACK_ADASBOARD_COUNT_API = 'Back admin dashboard API';

export default store => next => action => {

    const callAPI = action[BACK_ADASBOARD_COUNT_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_ADASBOARD_COUNT_API]
        return finalAction
    }
