...
export const BACK_ADMIN_DEPARTMENTS_API = 'Back admin departments API';

export default store => next => action => {

    const callAPI = action[BACK_ADMIN_DEPARTMENTS_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_ADMIN_DEPARTMENTS_API]
        return finalAction
    }
