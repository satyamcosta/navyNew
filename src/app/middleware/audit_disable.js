const API_ROOT = "/audit_view_service";
...
export const BACK_AUDIT_API = "Back Audit API";

export default (store) => (next) => (action) => {
  const callAPI = action[BACK_AUDIT_API];
  ...
  const actionWith = (data) => {
    ...
    delete finalAction[BACK_AUDIT_API];
    return finalAction;
  };
...
// export const BACK_RTI_API = "Back Rti API";

// export default store => next => action => {

//   const callAPI = action[BACK_RTI_API]
//   if (typeof callAPI === 'undefined') {
//     return next(action)
//   }
