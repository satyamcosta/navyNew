...
const PaginationComp2 = (props) => {
  ...
  const handleChange = (event, value) => {
    ...
    searchParamsSetter("pageNum", value);
  };
  ...
  const handleChangePage = (e) => {
    ...
    setCurrentPage(1);
    searchParamsSetter("pageSize", e.target.value);
  };
  ...
  return (
    ...
    >
      ...
      <div>
        <Typography>
          {currentPage} of {pageNumber} {t("pages")} ({totalCount} {t("files")})
        </Typography>
      </div>
    </Grid>
  );
...
export default memo(PaginationComp2);
